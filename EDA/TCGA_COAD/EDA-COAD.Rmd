...
# heatmapTable: COAD
```{r message=FALSE}
validate_coad <- validate(tcga_coad, RAVmodel)
...
graph_categorical <- function(a, b, c, d, e = 'Legend') {
>>>>>>> 201598d483526fe037bb8b6e15712e16be1eb529
...
```
```{r warning=FALSE}
graph_categorical(834, 1302, 'patient.microsatellite_instability_test_results.microsatellite_instability_test_result.mononucleotide_and_dinucleotide_marker_panel_analysis_status', 'Microsatellite')
=======
